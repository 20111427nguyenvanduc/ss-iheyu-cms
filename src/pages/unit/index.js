          ...
          <Grid item sm={12}>
            <Box display={"flex"} justifyContent={"center"}>
              ...
              >
                ...
                <Typography
                  variant="p"
                  sx={{ fontSize: "22px", color: "#2E3236", fontWeight: 700 }}
                >
                  {_.get(unitCurrent, "name")}
                </Typography>
                <AddEditUnit onClose={getList} unitCurrent={unitCurrent} detail={unitCurrent}>
                  <i
                    className="icon-bold-edit-2"
                    style={{ color: "#007CFE", fontSize: "22px", cursor: "pointer" }}
                  />
                </AddEditUnit>
                <VectorRight />
              </Stack>
                  ...
                  >
                    ...
                    >
                      ...
                      <Stack
                        direction="row"
                        spacing={2}
                        sx={{ justifyContent: "flex-end", alignItems: "center", cursor: "pointer" }}
                      >
                        <Link to={"/unit/" + _.get(item, "_id")}>
                          <i
                            className="icon-bold-eye"
                  ...
                  <Link underline="hover" key={i} color="#2E3236" to={"/position/" + item._id}>
                    ...
                    >
                      ...
                      >
                        ...
                        <i
                          className="icon-linear-arrow-right-1"
                          style={{ color: "#007CFE", fontSize: "22px" }}
                        />
                      </Stack>
                    </Box>
