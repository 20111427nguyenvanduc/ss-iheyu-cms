            ...
            <ProfileChip
                ...
                icon={
                    <ProfileAvatar
                        ...
                        color="inherit"
                    >
                        {_.get(user, 'name.first[0]')}{_.get(user, 'name.last[0]')}
                    </ProfileAvatar>
                }
                label={<ProfileInfWrap>
                    <Typography variant="body1">{Object.values(_.get(user, 'name', {})).join(' ')}</Typography>
                    <Box display="flex" alignItems="center" gap="4px">
                        <Box >{_.get(user, 'code') ? `TĐV ${_.get(user, 'code')}` : 'Quản trị viên' }</Box><IconSettings fontSize="15px"/>
                    </Box>
                </ProfileInfWrap>}
                variant="outlined"
                ref={anchorRef}
                                ...
                                <MainCard border={false} elevation={16} content={false} boxShadow shadow={theme.shadows[16]}>
                                    <CardContent>
                                        ...
                                        <NavContainer component="nav" sx={{ borderRadius: `${customization.borderRadius}px`}}>
                                            ...
                                            >
                                                <ListItemIcon>
                                                {customization.mode === 'dark'? <DarkModeIcon stroke={1.5} size="1.3rem" />: <LightModeIcon stroke={1.5} size="1.3rem" />}
                                                </ListItemIcon>
