...
export default function Search({placeholder = "Tìm kiếm", textSearch = "", searchChange = noOp, onSubmit = noOp}) {
 ...
 return (
  <Paper
   ...
   component='form'
   sx={{p: "2px 4px", display: "flex", alignItems: "center", width: 400, boxShadow: "none", borderRadius: "32px", border: "1px solid #CCCFD3"}}
  >
   <IconButton sx={{p: "10px"}} aria-label='menu' onClick={(e) => onSubmit()}>
    <SearchIcon />
   </IconButton>
