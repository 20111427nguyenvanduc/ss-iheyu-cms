...
const routes = {
  ...
  children: [
    ...
    {
      path: "/petition",
      load: () => import(/* webpackChunkName: 'petition' */ "./petition"),
    },
    {
      path: "/petition/process",
      load: () => import(/* webpackChunkName: 'petition-process' */ "./petition/process"),
    },
    {
      path: ["/category"],
    ...
    },
    {
      ...
      load: () =>
        import(/* webpackChunkName: 'group-permission-detail' */ "./group-permission/detail"),
    },
    {
    ...
    },
    {
      ...
      load: () =>
        import(/* webpackChunkName: 'digital-utilities-detail' */ "./digitalUtilities/detail"),
    },
    {
